...
const getNewOutputPrioritySetting = (activePower, batteryVoltage, chargeSum, dischargeSum, timestamp, currentBatterySetting, threshold1 = 50, threshold2 = 25, multiplier = 1) => {
    ...
    if (batteryVoltage < '50.5' && currentBatterySetting === valueMap[SBU_VAL]) {
        ...
        return SBU_VAL;
    } else if (currentTime > '18:00:00' && currentTime < '22:00:00' && (((+chargeSum) - (+dischargeSum)) * 0.1 * multiplier < threshold2 || activePower > '1000') && currentBatterySetting === valueMap[SBU_VAL]) {
        return SUB_VAL;
    } else if (currentTime > '18:00:00' && currentTime < '22:00:00' && (((+chargeSum) - (+dischargeSum)) * 0.1 * multiplier > threshold2 && activePower < '1000') && currentBatterySetting === valueMap[SUB_VAL]) {
        return SBU_VAL;
