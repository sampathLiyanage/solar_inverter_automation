...
const getNewOutputPrioritySettingBasedOnChargeDischargeData = (batteryVoltage, chargeSum, dischargeSum, timestamp, currentBatterySetting, threshold1 = 50, threshold2 = 25,  multiplier = 1) => {
    const currentTime = timestamp.substring(11,24);
